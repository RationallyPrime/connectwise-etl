...
-- Using proper [Lakehouse].[schema].[table] syntax
-- ============================================
...
FROM [Lakehouse].[gold].[gold_cw_fact_agreement_period]
...
FROM [Lakehouse].[gold].[gold_cw_fact_agreement_summary]
...
FROM [Lakehouse].[gold].[gold_cw_fact_time_entry]
...
FROM [Lakehouse].[gold].[gold_cw_fact_agreement_period] ap
LEFT JOIN [Lakehouse].[gold].[gold_cw_fact_agreement_summary] ash ON ap.id = ash.id
...
FROM [Lakehouse].[gold].[gold_cw_fact_invoice_line]
...
SELECT 
    ...
    COUNT(DISTINCT companyId) as unique_customers
FROM [Lakehouse].[gold].[gold_cw_fact_invoice_header]
