...
try:
    ...
    class Customer(SparkModel):
        ...
        No: Optional[str] = Field(default=None, alias="No-18")
        Name: Optional[str] = Field(default=None, alias="Name-18")
...
class TestSparkSchemaGeneration:
    ...
    def test_time_entry_schema(self):
        ...
        assert str(hours_field.dataType) in ["DoubleType", "DoubleType()", "FloatType", "FloatType()"]
