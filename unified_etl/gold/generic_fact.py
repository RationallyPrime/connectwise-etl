...
from unified_etl.gold.utils import join_dimension, add_audit_columns
...
def create_fact_table(
    ...
    **kwargs: Any
    ...
    try:
        ...
        error_msg = f"Failed to create fact table for {entity_name}: {str(e)}"
...
def create_generic_fact_tables(
    ...
    if entities is None:
        entities = [
            ...
            "VendorLedgerEntry", "JobLedgerEntry"
        ]
    ...
    for entity_name in entities:
        try:
            ...
            logging.error(f"Failed to create fact table for {entity_name}: {str(e)}")
