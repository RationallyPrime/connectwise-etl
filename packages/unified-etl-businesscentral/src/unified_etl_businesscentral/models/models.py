...
class JobLedgerEntry(SparkModel):
    ...
    Type: int | None = Field(None, json_schema_extra={"x-cdm-name": "Type-5"}, title="Type")
    No: str | None = Field(
...
class Item(SparkModel):
    ...
    Type: int | None = Field(None, json_schema_extra={"x-cdm-name": "Type-10"}, title="Type")
...
class CustLedgerEntry(SparkModel):
    ...
    Open: bool | None = Field(None, json_schema_extra={"x-cdm-name": "Open-36"}, title="Open")
...
class SalesInvoiceLine(SparkModel):
    ...
    LineNo: int | None = Field(None, json_schema_extra={"x-cdm-name": "LineNo-4"}, title="Line No.")
    Type: int | None = Field(None, json_schema_extra={"x-cdm-name": "Type-5"}, title="Type")
    No: str | None = Field(
...
class Job(SparkModel):
    ...
    Status: int | None = Field(None, json_schema_extra={"x-cdm-name": "Status-19"}, title="Status")
...
class Resource(SparkModel):
    ...
    Type: int | None = Field(None, json_schema_extra={"x-cdm-name": "Type-2"}, title="Type")
    Name: str | None = Field(
...
class AccountingPeriod(SparkModel):
    ...
    Closed: bool | None = Field(None, json_schema_extra={"x-cdm-name": "Closed-4"}, title="Closed")
