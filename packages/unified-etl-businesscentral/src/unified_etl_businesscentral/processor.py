...
class BusinessCentralBronzeProcessor:
    ...
    def process_entity(self, entity_name: str, model_class: type[SparkModel]) -> DataFrame:
        ...
        try:
            ...
            raise ETLProcessingError(
                f"Failed to read bronze table for {entity_name}: {str(e)}",
        ...
        try:
            ...
            raise ETLProcessingError(
                f"Failed to collect BC2ADLS data for {entity_name}: {str(e)}",
        ...
        try:
            ...
            raise ETLProcessingError(
                f"Failed to create SparkDantic DataFrame for {entity_name}: {str(e)}",
    ...
    def extract_all(self) -> dict[str, list[dict[str, Any]]]:
        ...
        """
        from . import models, SILVER_CONFIG
    ...
    def list_available_entities(self) -> list[str]:
        ...
        try:
            ...
            path = self.spark._jvm.org.apache.hadoop.fs.Path(self.bc2adls_path)
