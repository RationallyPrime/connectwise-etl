...
-- Using correct table names: gold_cw_[entity]_facts
-- ============================================
...
FROM [Lakehouse].[gold].[gold_cw_agreement_period_facts]
...
FROM [Lakehouse].[gold].[gold_cw_agreement_summary_facts]
...
FROM [Lakehouse].[gold].[gold_cw_time_entry_facts]
...
FROM [Lakehouse].[gold].[gold_cw_agreement_period_facts] ap
LEFT JOIN [Lakehouse].[gold].[gold_cw_agreement_summary_facts] ash ON ap.id = ash.id
...
FROM [Lakehouse].[gold].[gold_cw_invoice_line_facts]
...
SELECT 
    ...
    COUNT(DISTINCT companyId) as unique_customers
FROM [Lakehouse].[gold].[gold_cw_invoice_header_facts]
