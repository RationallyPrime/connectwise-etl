...
class AccountingPeriod(SparkModel):
    ...
    starting_date: datetime.date | None = Field(
    ...
    new_fiscal_year: bool | None = Field(
...
class CompanyInformation(SparkModel):
    ...
    country_region_code: str | None = Field(
        default=None,
        alias="CountryRegionCode-36",
        description="Country/Region Code. Max length: 10",
    )
    shipto_country_region_code: str | None = Field(
        default=None,
...
class CustLedgerEntry(SparkModel):
    ...
    posting_date: datetime.date | None = Field(
    ...
    sales_lcy: float | None = Field(
        default=None, alias="SalesLCY-18", description="Sales (LCY). Max length: 12. Scale: 5"
    )
    profit_lcy: float | None = Field(
        default=None, alias="ProfitLCY-19", description="Profit (LCY). Max length: 12. Scale: 5"
    )
    inv_discount_lcy: float | None = Field(
        default=None,
        alias="InvDiscountLCY-20",
        description="Inv. Discount (LCY). Max length: 12. Scale: 5",
    )
    sellto_customer_no: str | None = Field(
        default=None,
        alias="SelltoCustomerNo-21",
        description="Sell-to Customer No.. Max length: 20",
    )
    customer_posting_group: str | None = Field(
        default=None,
        alias="CustomerPostingGroup-22",
        description="Customer Posting Group. Max length: 20",
    )
    global_dimension1_code: str | None = Field(
        default=None,
        alias="GlobalDimension1Code-23",
        description="Global Dimension 1 Code. Max length: 20",
    )
    global_dimension2_code: str | None = Field(
        default=None,
        alias="GlobalDimension2Code-24",
        description="Global Dimension 2 Code. Max length: 20",
    )
    salesperson_code: str | None = Field(
    ...
    pmt_discount_date: datetime.date | None = Field(
        default=None, alias="PmtDiscountDate-38", description="Pmt. Discount Date. Max length: 4"
    )
    original_pmt_disc_possible: float | None = Field(
        default=None,
        alias="OriginalPmtDiscPossible-39",
        description="Original Pmt. Disc. Possible. Max length: 12. Scale: 5",
    )
    pmt_disc_given_lcy: float | None = Field(
        default=None,
        alias="PmtDiscGivenLCY-40",
        description="Pmt. Disc. Given (LCY). Max length: 12. Scale: 5",
    )
    orig_pmt_disc_possible_lcy: float | None = Field(
        default=None,
        alias="OrigPmtDiscPossibleLCY-42",
        description="Orig. Pmt. Disc. Possible(LCY). Max length: 12. Scale: 5",
    )
    positive: bool | None = Field(
        default=None, alias="Positive-43", description="Positive. Max length: 4"
    )
    closedby_entry_no: int | None = Field(
        default=None, alias="ClosedbyEntryNo-44", description="Closed by Entry No.. Max length: 4"
    )
    closedat_date: datetime.date | None = Field(
        default=None, alias="ClosedatDate-45", description="Closed at Date. Max length: 4"
    )
    closedby_amount: float | None = Field(
        default=None,
        alias="ClosedbyAmount-46",
        description="Closed by Amount. Max length: 12. Scale: 5",
    )
    appliesto_id: str | None = Field(
        default=None, alias="AppliestoID-47", description="Applies-to ID. Max length: 50"
    )
    journal_templ_name: str | None = Field(
        default=None, alias="JournalTemplName-48", description="Journal Templ. Name. Max length: 10"
    )
    journal_batch_name: str | None = Field(
    ...
    bal_account_type: int | None = Field(
        default=None, alias="BalAccountType-51", description="Bal. Account Type. Max length: 4"
    )
    bal_account_no: str | None = Field(
        default=None, alias="BalAccountNo-52", description="Bal. Account No.. Max length: 20"
    )
    transaction_no: int | None = Field(
        default=None, alias="TransactionNo-53", description="Transaction No.. Max length: 4"
    )
    closedby_amount_lcy: float | None = Field(
        default=None,
        alias="ClosedbyAmountLCY-54",
        description="Closed by Amount (LCY). Max length: 12. Scale: 5",
    )
    document_date: datetime.date | None = Field(
        default=None, alias="DocumentDate-62", description="Document Date. Max length: 4"
    )
    external_document_no: str | None = Field(
        default=None,
        alias="ExternalDocumentNo-63",
        description="External Document No.. Max length: 35",
    )
    calculate_interest: bool | None = Field(
        default=None, alias="CalculateInterest-64", description="Calculate Interest. Max length: 4"
    )
    closing_interest_calculated: bool | None = Field(
        default=None,
        alias="ClosingInterestCalculated-65",
        description="Closing Interest Calculated. Max length: 4",
    )
    no_series: str | None = Field(
        default=None, alias="NoSeries-66", description="No. Series. Max length: 20"
    )
    closedby_currency_code: str | None = Field(
        default=None,
        alias="ClosedbyCurrencyCode-67",
        description="Closed by Currency Code. Max length: 10",
    )
    closedby_currency_amount: float | None = Field(
        default=None,
        alias="ClosedbyCurrencyAmount-68",
        description="Closed by Currency Amount. Max length: 12. Scale: 5",
    )
    adjusted_currency_factor: float | None = Field(
        default=None,
        alias="AdjustedCurrencyFactor-73",
        description="Adjusted Currency Factor. Max length: 12. Scale: 5",
    )
    original_currency_factor: float | None = Field(
        default=None,
        alias="OriginalCurrencyFactor-74",
        description="Original Currency Factor. Max length: 12. Scale: 5",
    )
    remaining_pmt_disc_possible: float | None = Field(
        default=None,
        alias="RemainingPmtDiscPossible-77",
        description="Remaining Pmt. Disc. Possible. Max length: 12. Scale: 5",
    )
    pmt_disc_tolerance_date: datetime.date | None = Field(
        default=None,
        alias="PmtDiscToleranceDate-78",
        description="Pmt. Disc. Tolerance Date. Max length: 4",
    )
    max_payment_tolerance: float | None = Field(
        default=None,
        alias="MaxPaymentTolerance-79",
        description="Max. Payment Tolerance. Max length: 12. Scale: 5",
    )
    last_issued_reminder_level: int | None = Field(
        default=None,
        alias="LastIssuedReminderLevel-80",
        description="Last Issued Reminder Level. Max length: 4",
    )
    accepted_payment_tolerance: float | None = Field(
        default=None,
        alias="AcceptedPaymentTolerance-81",
        description="Accepted Payment Tolerance. Max length: 12. Scale: 5",
    )
    accepted_pmt_disc_tolerance: bool | None = Field(
        default=None,
        alias="AcceptedPmtDiscTolerance-82",
        description="Accepted Pmt. Disc. Tolerance. Max length: 4",
    )
    pmt_tolerance_lcy: float | None = Field(
        default=None,
        alias="PmtToleranceLCY-83",
        description="Pmt. Tolerance (LCY). Max length: 12. Scale: 5",
    )
    amountto_apply: float | None = Field(
        default=None,
        alias="AmounttoApply-84",
        description="Amount to Apply. Max length: 12. Scale: 5",
    )
    ic_partner_code: str | None = Field(
        default=None, alias="ICPartnerCode-85", description="IC Partner Code. Max length: 20"
    )
    applying_entry: bool | None = Field(
...
class Customer(SparkModel):
    ...
    budgeted_amount: float | None = Field(
        default=None,
        alias="BudgetedAmount-19",
        description="Budgeted Amount. Max length: 12. Scale: 5",
    )
    credit_limit_lcy: float | None = Field(
        default=None,
        alias="CreditLimitLCY-20",
        description="Credit Limit (LCY). Max length: 12. Scale: 5",
    )
    customer_posting_group: str | None = Field(
        default=None,
    ...
    customer_price_group: str | None = Field(
        default=None,
    ...
    customer_disc_group: str | None = Field(
        default=None,
    ...
    gen_bus_posting_group: str | None = Field(
        default=None,
...
class DetailedCustLedgEntry(SparkModel):
    ...
    amount: float | None = Field(
        default=None, alias="Amount-7", description="Amount. Max length: 12. Scale: 5"
    )
    amount_lcy: float | None = Field(
        default=None, alias="AmountLCY-8", description="Amount (LCY). Max length: 12. Scale: 5"
    )
    currency_code: str | None = Field(
    ...
    debit_amount: float | None = Field(
        default=None, alias="DebitAmount-16", description="Debit Amount. Max length: 12. Scale: 5"
    )
    credit_amount: float | None = Field(
        default=None, alias="CreditAmount-17", description="Credit Amount. Max length: 12. Scale: 5"
    )
    debit_amount_lcy: float | None = Field(
        default=None,
        alias="DebitAmountLCY-18",
        description="Debit Amount (LCY). Max length: 12. Scale: 5",
    )
    credit_amount_lcy: float | None = Field(
        default=None,
        alias="CreditAmountLCY-19",
        description="Credit Amount (LCY). Max length: 12. Scale: 5",
    )
    timestamp: int | None = Field(
        default=None, alias="timestamp-0", description="timestamp. Max length: 8"
    )
...
class DetailedVendorLedgEntry(SparkModel):
    ...
    vendor_ledger_entry_no: int | None = Field(
        default=None,
    ...
    initial_entry_due_date: datetime.date | None = Field(
        default=None,
...
class Dimension(SparkModel):
    ...
    mapto_ic_dimension_code: str | None = Field(
        default=None,
...
class DimensionValue(SparkModel):
    ...
    dimension_value_type: int | None = Field(
        default=None,
    ...
    mapto_ic_dimension_value_code: str | None = Field(
        default=None,
...
class GLAccount(SparkModel):
    ...
    last_date_modified: datetime.date | None = Field(
...
class GLEntry(SparkModel):
    ...
    amount: float | None = Field(
        default=None, alias="Amount-17", description="Amount. Max length: 12. Scale: 5"
    )
    global_dimension1_code: str | None = Field(
        default=None,
        alias="GlobalDimension1Code-23",
    ...
    system_created_entry: bool | None = Field(
        default=None,
        alias="SystemCreatedEntry-29",
        description="System-Created Entry. Max length: 4",
    )
    prior_year_entry: bool | None = Field(
        default=None, alias="PriorYearEntry-30", description="Prior-Year Entry. Max length: 4"
    )
    job_no: str | None = Field(
        default=None, alias="JobNo-41", description="Job No.. Max length: 20"
    )
    quantity: float | None = Field(
        default=None, alias="Quantity-42", description="Quantity. Max length: 12. Scale: 5"
    )
    vat_amount: float | None = Field(
        default=None, alias="VATAmount-43", description="VAT Amount. Max length: 12. Scale: 5"
    )
    business_unit_code: str | None = Field(
    ...
    debit_amount: float | None = Field(
        default=None, alias="DebitAmount-53", description="Debit Amount. Max length: 12. Scale: 5"
    )
    credit_amount: float | None = Field(
        default=None, alias="CreditAmount-54", description="Credit Amount. Max length: 12. Scale: 5"
    )
    document_date: datetime.date | None = Field(
    ...
    additional_currency_amount: float | None = Field(
        default=None,
        alias="AdditionalCurrencyAmount-68",
        description="Additional-Currency Amount. Max length: 12. Scale: 5",
    )
    add_currency_debit_amount: float | None = Field(
        default=None,
        alias="AddCurrencyDebitAmount-69",
        description="Add.-Currency Debit Amount. Max length: 12. Scale: 5",
    )
    add_currency_credit_amount: float | None = Field(
        default=None,
        alias="AddCurrencyCreditAmount-70",
        description="Add.-Currency Credit Amount. Max length: 12. Scale: 5",
    )
    close_income_statement_dim_id: int | None = Field(
        default=None,
    ...
    non_deductible_vat_amount: float | None = Field(
        default=None,
        alias="NonDeductibleVATAmount-6200",
        description="Non-Deductible VAT Amount. Max length: 12. Scale: 5",
    )
    non_deductible_vat_amount_acy: float | None = Field(
        default=None,
        alias="NonDeductibleVATAmountACY-6201",
        description="Non-Deductible VAT Amount ACY. Max length: 12. Scale: 5",
    )
    last_modified_date_time: datetime.datetime | None = Field(
        default=None,
...
class Item(SparkModel):
    ...
    base_unitof_measure: str | None = Field(
        default=None,
    ...
    inventory_posting_group: str | None = Field(
        default=None,
        alias="InventoryPostingGroup-11",
        description="Inventory Posting Group. Max length: 20",
    )
    item_disc_group: str | None = Field(
        default=None, alias="ItemDiscGroup-14", description="Item Disc. Group. Max length: 20"
    )
    unit_price: float | None = Field(
        default=None, alias="UnitPrice-18", description="Unit Price. Max length: 12. Scale: 5"
    )
    unit_cost: float | None = Field(
        default=None, alias="UnitCost-22", description="Unit Cost. Max length: 12. Scale: 5"
    )
    vendor_no: str | None = Field(
        default=None, alias="VendorNo-31", description="Vendor No.. Max length: 20"
    )
    vendor_item_no: str | None = Field(
        default=None, alias="VendorItemNo-32", description="Vendor Item No.. Max length: 50"
    )
    gross_weight: float | None = Field(
        default=None, alias="GrossWeight-41", description="Gross Weight. Max length: 12. Scale: 5"
    )
    net_weight: float | None = Field(
        default=None, alias="NetWeight-42", description="Net Weight. Max length: 12. Scale: 5"
    )
    unit_volume: float | None = Field(
        default=None, alias="UnitVolume-44", description="Unit Volume. Max length: 12. Scale: 5"
    )
    blocked: bool | None = Field(
    ...
    assembly_policy: int | None = Field(
...
class Job(SparkModel):
    ...
    no: str | None = Field(default=None, alias="No-1", description="No.. Max length: 20")
    search_description: str | None = Field(
    ...
    ending_date: datetime.date | None = Field(
    ...
    person_responsible: str | None = Field(
    ...
    job_posting_group: str | None = Field(
...
class JobLedgerEntry(SparkModel):
    ...
    quantity: float | None = Field(
        default=None, alias="Quantity-9", description="Quantity. Max length: 12. Scale: 5"
    )
    direct_unit_cost_lcy: float | None = Field(
        default=None,
        alias="DirectUnitCostLCY-11",
        description="Direct Unit Cost (LCY). Max length: 12. Scale: 5",
    )
    unit_cost_lcy: float | None = Field(
        default=None,
        alias="UnitCostLCY-12",
        description="Unit Cost (LCY). Max length: 12. Scale: 5",
    )
    total_cost_lcy: float | None = Field(
        default=None,
        alias="TotalCostLCY-13",
        description="Total Cost (LCY). Max length: 12. Scale: 5",
    )
    unit_price_lcy: float | None = Field(
        default=None,
        alias="UnitPriceLCY-14",
        description="Unit Price (LCY). Max length: 12. Scale: 5",
    )
    total_price_lcy: float | None = Field(
        default=None,
        alias="TotalPriceLCY-15",
        description="Total Price (LCY). Max length: 12. Scale: 5",
    )
    resource_group_no: str | None = Field(
        default=None, alias="ResourceGroupNo-16", description="Resource Group No.. Max length: 20"
    )
    unitof_measure_code: str | None = Field(
        default=None,
    ...
    shpt_method_code: str | None = Field(
        default=None, alias="ShptMethodCode-40", description="Shpt. Method Code. Max length: 10"
    )
    amtto_postto_gl: float | None = Field(
        default=None,
        alias="AmttoPosttoGL-60",
        description="Amt. to Post to G/L. Max length: 12. Scale: 5",
    )
    amt_postedto_gl: float | None = Field(
        default=None,
        alias="AmtPostedtoGL-61",
        description="Amt. Posted to G/L. Max length: 12. Scale: 5",
    )
    entry_type: int | None = Field(
    ...
    transport_method: str | None = Field(
    ...
    entry_exit_point: str | None = Field(
    ...
    transaction_specification: str | None = Field(
        default=None,
    ...
    additional_currency_total_cost: float | None = Field(
        default=None,
        alias="AdditionalCurrencyTotalCost-88",
        description="Additional-Currency Total Cost. Max length: 12. Scale: 5",
    )
    add_currency_total_price: float | None = Field(
        default=None,
        alias="AddCurrencyTotalPrice-89",
        description="Add.-Currency Total Price. Max length: 12. Scale: 5",
    )
    add_currency_line_amount: float | None = Field(
        default=None,
        alias="AddCurrencyLineAmount-94",
        description="Add.-Currency Line Amount. Max length: 12. Scale: 5",
    )
    dimension_set_id: int | None = Field(
        default=None, alias="DimensionSetID-480", description="Dimension Set ID. Max length: 4"
    )
    job_task_no: str | None = Field(
        default=None, alias="JobTaskNo-1000", description="Job Task No.. Max length: 20"
    )
    line_amount_lcy: float | None = Field(
        default=None,
        alias="LineAmountLCY-1001",
        description="Line Amount (LCY). Max length: 12. Scale: 5",
    )
    unit_cost: float | None = Field(
        default=None, alias="UnitCost-1002", description="Unit Cost. Max length: 12. Scale: 5"
    )
    total_cost: float | None = Field(
        default=None, alias="TotalCost-1003", description="Total Cost. Max length: 12. Scale: 5"
    )
    unit_price: float | None = Field(
        default=None, alias="UnitPrice-1004", description="Unit Price. Max length: 12. Scale: 5"
    )
    total_price: float | None = Field(
        default=None, alias="TotalPrice-1005", description="Total Price. Max length: 12. Scale: 5"
    )
    line_amount: float | None = Field(
        default=None, alias="LineAmount-1006", description="Line Amount. Max length: 12. Scale: 5"
    )
    line_discount_amount: float | None = Field(
        default=None,
        alias="LineDiscountAmount-1007",
        description="Line Discount Amount. Max length: 12. Scale: 5",
    )
    line_discount_amount_lcy: float | None = Field(
        default=None,
        alias="LineDiscountAmountLCY-1008",
        description="Line Discount Amount (LCY). Max length: 12. Scale: 5",
    )
    currency_code: str | None = Field(
        default=None, alias="CurrencyCode-1009", description="Currency Code. Max length: 10"
    )
    currency_factor: float | None = Field(
        default=None,
        alias="CurrencyFactor-1010",
        description="Currency Factor. Max length: 12. Scale: 5",
    )
    description2: str | None = Field(
        default=None, alias="Description2-1016", description="Description 2. Max length: 50"
    )
    ledger_entry_type: int | None = Field(
        default=None, alias="LedgerEntryType-1017", description="Ledger Entry Type. Max length: 4"
    )
    ledger_entry_no: int | None = Field(
    ...
    line_discount: float | None = Field(
        default=None,
        alias="LineDiscount-1021",
        description="Line Discount %. Max length: 12. Scale: 5",
    )
    line_type: int | None = Field(
        default=None, alias="LineType-1022", description="Line Type. Max length: 4"
    )
    original_unit_cost_lcy: float | None = Field(
        default=None,
        alias="OriginalUnitCostLCY-1023",
        description="Original Unit Cost (LCY). Max length: 12. Scale: 5",
    )
    original_total_cost_lcy: float | None = Field(
        default=None,
        alias="OriginalTotalCostLCY-1024",
        description="Original Total Cost (LCY). Max length: 12. Scale: 5",
    )
    original_unit_cost: float | None = Field(
        default=None,
        alias="OriginalUnitCost-1025",
        description="Original Unit Cost. Max length: 12. Scale: 5",
    )
    original_total_cost: float | None = Field(
        default=None,
        alias="OriginalTotalCost-1026",
        description="Original Total Cost. Max length: 12. Scale: 5",
    )
    original_total_cost_acy: float | None = Field(
        default=None,
        alias="OriginalTotalCostACY-1027",
        description="Original Total Cost (ACY). Max length: 12. Scale: 5",
    )
    adjusted: bool | None = Field(
        default=None, alias="Adjusted-1028", description="Adjusted. Max length: 4"
    )
    date_time_adjusted: datetime.datetime | None = Field(
...
class Resource(SparkModel):
    ...
    social_security_no: str | None = Field(
    ...
    employment_date: datetime.date | None = Field(
    ...
    direct_unit_cost: float | None = Field(
        default=None,
        alias="DirectUnitCost-19",
        description="Direct Unit Cost. Max length: 12. Scale: 5",
    )
    unit_cost: float | None = Field(
        default=None, alias="UnitCost-21", description="Unit Cost. Max length: 12. Scale: 5"
    )
    unit_price: float | None = Field(
        default=None, alias="UnitPrice-24", description="Unit Price. Max length: 12. Scale: 5"
    )
    vendor_no: str | None = Field(
...
class SalesInvoiceHeader(SparkModel):
    ...
    order_date: datetime.date | None = Field(
    ...
    payment_discount: float | None = Field(
        default=None,
        alias="PaymentDiscount-25",
        description="Payment Discount %. Max length: 12. Scale: 5",
    )
    pmt_discount_date: datetime.date | None = Field(
        default=None, alias="PmtDiscountDate-26", description="Pmt. Discount Date. Max length: 4"
    )
    shipment_method_code: str | None = Field(
        default=None,
    ...
    eu3_party_trade: bool | None = Field(
    ...
    vat_country_region_code: str | None = Field(
        default=None,
    ...
    vat_base_discount: float | None = Field(
        default=None,
        alias="VATBaseDiscount-119",
        description="VAT Base Discount %. Max length: 12. Scale: 5",
    )
    invoice_discount_calculation: int | None = Field(
        default=None,
        alias="InvoiceDiscountCalculation-121",
        description="Invoice Discount Calculation. Max length: 4",
    )
    invoice_discount_value: float | None = Field(
        default=None,
        alias="InvoiceDiscountValue-122",
        description="Invoice Discount Value. Max length: 12. Scale: 5",
    )
    prepayment_no_series: str | None = Field(
        default=None,
        alias="PrepaymentNoSeries-131",
        description="Prepayment No. Series. Max length: 20",
    )
    prepayment_invoice: bool | None = Field(
        default=None, alias="PrepaymentInvoice-136", description="Prepayment Invoice. Max length: 4"
    )
    prepayment_order_no: str | None = Field(
        default=None,
        alias="PrepaymentOrderNo-137",
        description="Prepayment Order No.. Max length: 20",
    )
    quote_no: str | None = Field(
        default=None, alias="QuoteNo-151", description="Quote No.. Max length: 20"
    )
    company_bank_account_code: str | None = Field(
        default=None,
...
class SalesInvoiceLine(SparkModel):
    ...
    unitof_measure: str | None = Field(
        default=None, alias="UnitofMeasure-13", description="Unit of Measure. Max length: 50"
    )
    quantity: float | None = Field(
        default=None, alias="Quantity-15", description="Quantity. Max length: 12. Scale: 5"
    )
    unit_price: float | None = Field(
        default=None, alias="UnitPrice-22", description="Unit Price. Max length: 12. Scale: 5"
    )
    unit_cost_lcy: float | None = Field(
        default=None,
        alias="UnitCostLCY-23",
        description="Unit Cost (LCY). Max length: 12. Scale: 5",
    )
    vat: float | None = Field(
        default=None, alias="VAT-25", description="VAT %. Max length: 12. Scale: 5"
    )
    line_discount: float | None = Field(
        default=None,
        alias="LineDiscount-27",
        description="Line Discount %. Max length: 12. Scale: 5",
    )
    line_discount_amount: float | None = Field(
        default=None,
    ...
    amount: float | None = Field(
        default=None, alias="Amount-29", description="Amount. Max length: 12. Scale: 5"
    )
    amount_including_vat: float | None = Field(
        default=None,
        alias="AmountIncludingVAT-30",
        description="Amount Including VAT. Max length: 12. Scale: 5",
    )
    allow_invoice_disc: bool | None = Field(
        default=None, alias="AllowInvoiceDisc-32", description="Allow Invoice Disc.. Max length: 4"
    )
    gross_weight: float | None = Field(
        default=None, alias="GrossWeight-34", description="Gross Weight. Max length: 12. Scale: 5"
    )
    net_weight: float | None = Field(
        default=None, alias="NetWeight-35", description="Net Weight. Max length: 12. Scale: 5"
    )
    unitsper_parcel: float | None = Field(
        default=None,
        alias="UnitsperParcel-36",
        description="Units per Parcel. Max length: 12. Scale: 5",
    )
    unit_volume: float | None = Field(
        default=None, alias="UnitVolume-37", description="Unit Volume. Max length: 12. Scale: 5"
    )
    applto_item_entry: int | None = Field(
    ...
    inv_discount_amount: float | None = Field(
        default=None,
        alias="InvDiscountAmount-69",
        description="Inv. Discount Amount. Max length: 12. Scale: 5",
    )
    drop_shipment: bool | None = Field(
    ...
    vat_calculation_type: int | None = Field(
        default=None,
    ...
    attachedto_line_no: int | None = Field(
    ...
    vat_clause_code: str | None = Field(
    ...
    blanket_order_no: str | None = Field(
        default=None, alias="BlanketOrderNo-97", description="Blanket Order No.. Max length: 20"
    )
    blanket_order_line_no: int | None = Field(
        default=None,
        alias="BlanketOrderLineNo-98",
        description="Blanket Order Line No.. Max length: 4",
    )
    vat_base_amount: float | None = Field(
        default=None,
        alias="VATBaseAmount-99",
        description="VAT Base Amount. Max length: 12. Scale: 5",
    )
    unit_cost: float | None = Field(
        default=None, alias="UnitCost-100", description="Unit Cost. Max length: 12. Scale: 5"
    )
    system_created_entry: bool | None = Field(
        default=None,
    ...
    line_amount: float | None = Field(
        default=None, alias="LineAmount-103", description="Line Amount. Max length: 12. Scale: 5"
    )
    vat_difference: float | None = Field(
        default=None,
        alias="VATDifference-104",
        description="VAT Difference. Max length: 12. Scale: 5",
    )
    vat_identifier: str | None = Field(
        default=None, alias="VATIdentifier-106", description="VAT Identifier. Max length: 20"
    )
    ic_partner_ref_type: int | None = Field(
        default=None,
        alias="ICPartnerRefType-107",
        description="IC Partner Ref. Type. Max length: 4",
    )
    ic_partner_reference: str | None = Field(
        default=None,
        alias="ICPartnerReference-108",
        description="IC Partner Reference. Max length: 20",
    )
    prepayment_line: bool | None = Field(
    ...
    ic_item_reference_no: str | None = Field(
        default=None,
        alias="ICItemReferenceNo-138",
        description="IC Item Reference No.. Max length: 50",
    )
    pmt_discount_amount: float | None = Field(
        default=None,
        alias="PmtDiscountAmount-145",
        description="Pmt. Discount Amount. Max length: 12. Scale: 5",
    )
    line_discount_calculation: int | None = Field(
        default=None,
    ...
    shpfy_order_line_id: int | None = Field(
        default=None,
...
class Vendor(SparkModel):
    ...
    vendor_posting_group: str | None = Field(
        default=None,
    ...
    statistics_group: int | None = Field(
    ...
    payto_vendor_no: str | None = Field(
    ...
    application_method: int | None = Field(
    ...
    fax_no: str | None = Field(
        default=None, alias="FaxNo-84", description="Fax No.. Max length: 30"
    )
    telex_answer_back: str | None = Field(
    ...
    e_mail: str | None = Field(
        default=None, alias="EMail-102", description="E-Mail. Max length: 80"
    )
    home_page: str | None = Field(
    ...
    block_payment_tolerance: bool | None = Field(
        default=None,
    ...
    lead_time_calculation: str | None = Field(
        default=None,
    ...
    payment_terms_id: str | None = Field(
...
class VendorLedgerEntry(SparkModel):
    ...
    purchase_lcy: float | None = Field(
        default=None, alias="PurchaseLCY-18", description="Purchase (LCY). Max length: 12. Scale: 5"
    )
    inv_discount_lcy: float | None = Field(
        default=None,
        alias="InvDiscountLCY-20",
    ...
    buyfrom_vendor_no: str | None = Field(
    ...
    pmt_disc_rcd_lcy: float | None = Field(
        default=None,
        alias="PmtDiscRcdLCY-40",
        description="Pmt. Disc. Rcd.(LCY). Max length: 12. Scale: 5",
    )
    orig_pmt_disc_possible_lcy: float | None = Field(
        default=None,
        alias="OrigPmtDiscPossibleLCY-42",
    ...
    invoice_received_date: datetime.date | None = Field(
        default=None,
