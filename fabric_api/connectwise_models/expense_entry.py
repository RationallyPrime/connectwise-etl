...
#   filename:  tmp90ff7icq.json
#   timestamp: 2025-05-14T11:34:07+00:00
...
class BillingCycleReference(AgreementTypeReference):
    pass


class BillingSetupReference(AgreementTypeReference):
    pass


class BillingStatusReference(AgreementTypeReference):
    pass


class BillingTermsReference(AgreementTypeReference):
    pass


class BillingUnitReference(AgreementTypeReference):
    pass


class CatalogItemReference(AgreementTypeReference):
    pass


class ClassificationReference(AgreementTypeReference):
    pass


class CompanyReference(AgreementTypeReference):
    pass


class ContactReference(AgreementTypeReference):
    pass


class CurrencyReference(AgreementTypeReference):
    pass


class CustomFieldValue(AgreementTypeReference):
    pass


class EntityTypeReference(AgreementTypeReference):
    pass


class ExpenseReportReference(AgreementTypeReference):
    pass


class ExpenseTax(AgreementTypeReference):
    pass


class ExpenseTypeReference(AgreementTypeReference):
    pass


class InvoiceGroupingReference(AgreementTypeReference):
    pass


class InvoiceReference(AgreementTypeReference):
    pass


class InvoiceTemplateDetailReference(AgreementTypeReference):
    pass


class InvoiceTemplateReference(AgreementTypeReference):
    pass


class MemberReference(AgreementTypeReference):
    pass


class OpportunityReference(AgreementTypeReference):
    pass


class OpportunityStatusReference(AgreementTypeReference):
    pass


class OwnerLevelReference(AgreementTypeReference):
    pass


class PaymentMethodReference(AgreementTypeReference):
    pass


class ProductRecurring(AgreementTypeReference):
    pass


class ProjectPhaseReference(AgreementTypeReference):
    pass


class ProjectReference(AgreementTypeReference):
    pass


class ProjectTypeReference(AgreementTypeReference):
    pass


class SLAReference(AgreementTypeReference):
    pass


class SalesOrderReference(AgreementTypeReference):
    pass


class SiteReference(AgreementTypeReference):
    pass


class SystemDepartmentReference(AgreementTypeReference):
    pass


class SystemLocationReference(AgreementTypeReference):
    pass


class TaxCodeReference(AgreementTypeReference):
    pass


class TicketReference(AgreementTypeReference):
    pass


class TimeSheetReference(AgreementTypeReference):
    pass


class UnitOfMeasureReference(AgreementTypeReference):
    pass


class WarehouseBinReference(AgreementTypeReference):
    pass


class WarehouseReference(AgreementTypeReference):
    pass


class WorkRoleReference(AgreementTypeReference):
    pass


class WorkTypeReference(AgreementTypeReference):
    pass
