...
This file contains all models to avoid circular imports.
"""
...
#   filename:  tmp65k165s0.json
#   timestamp: 2025-05-14T12:06:08+00:00
...
# These are already defined in Reference Models section, so we use the existing definitions:
# ActivityReference (already defined above)
# BatchReference (already defined above)

# Alias common reference types to match structure
UnitOfMeasureReference = ProjectReference
...
OpportunityStatusReference = ProjectReference


BillingCycleReference = ProjectReference


ExpenseReportReference = ProjectReference


ExpenseTypeReference = ProjectReference
...
EntityTypeReference = ProjectReference
...
# AgreementTypeReference (already defined above)
...
ExpenseTaxTypeReference = ProjectReference
...
ClassificationReference = ProjectReference


WarehouseBinReference = ProjectReference
...
PaymentMethodReference = ProjectReference
