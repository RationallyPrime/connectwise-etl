...
__all__ = ["get_agreement_with_relations", "get_all_agreements", "get_cached_agreement", "fetch_agreements_raw"]
...
def get_agreement_with_relations(
    ...
    try:
        ...
        try:
            ...
            _LOGGER.warning(f"Failed direct access for agreement {agreement_id}, fetching all agreements: {str(direct_exc)}")
        ...
        validated_agr = safe_validate(
            model_cls=ManageAgreement, 
            raw=agr, 
            errors=errors
        )
