...
DEFAULT_BC_OUTPUT_MODELS_FILE = "fabric_api/models/bc_models/models.py"
DEFAULT_BC_OUTPUT_INIT_FILE = "fabric_api/models/bc_models/__init__.py"
...
# Generated by fabric_api/generators/generate_bc_models.py
...
def generate_bc_models(
    ...
    print(f"Starting Pydantic BC model generation...")
