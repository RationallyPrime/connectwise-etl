...
def generate_psa_models(
    ...
    entities_to_include: Optional[List[str]] = None, # e.g. ["Agreement", "TimeEntry"]
    reference_models_to_include: Optional[List[str]] = None # e.g. ["ActivityReference"]
):
    """
    ...
    logger.info(f"Starting PSA Pydantic model generation...")
...
if __name__ == "__main__":
    ...
    logger.info(f"Running generate_psa_models.py directly.")
