...
def handle_errors(
    error_class: type[Exception] = BCETLExceptionError,
            ...
            try:
                ...
                if reraise:
                    ...
                    if not isinstance(e, error_class):
                        raise error_class(f"{msg}: {str(e)}") from e
...
def dimension_handler(
    ...
    Returns:
        Decorated function with standardized error handling
    """
    from bc_etl.utils.exceptions import DimensionError
