...
from bc_etl.utils import config_loader, construct_table_path, logging
...
def generate_date_dimension(
    ...
    try:
        with logging.span("generate_date_dimension"):
            ...
            from bc_etl.pipeline import write_with_schema_conflict_handling
        ...
        error_msg = f"Failed to generate date dimension: {str(e)}"
...
def create_dimension_bridge(
    ...
    try:
        ...
        error_msg = f"Failed to create dimension bridge: {str(e)}"
        logging.error(error_msg)
        raise DimensionResolutionError(error_msg) from e
    ...
    try:
        with logging.span("create_item_attribute_dimension"):
            ...
            try:
                ...
                error_msg = f"Failed to read {item_attribute_table} table: {str(err)}"
                logging.error(error_msg)
            ...
            try:
                ...
                error_msg = f"Failed to read {item_attribute_value_table} table: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
            ...
            if incremental:
                ...
                try:
                    ...
                    logging.warning(
                        f"Could not apply incremental filtering, using full load: {str(err)}"
                    )
            ...
            try:
                ...
                error_msg = f"Failed to join attribute tables: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
            ...
            try:
                ...
                error_msg = f"Failed to generate surrogate keys: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
            ...
            try:
                ...
                error_msg = f"Failed to write dimension table: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
        ...
        error_msg = f"Unexpected error in create_item_attribute_dimension: {str(err)}"
        logging.error(error_msg)
        raise DimensionResolutionError(error_msg) from err
    ...
    try:
        with logging.span("create_item_attribute_bridge"):
            ...
            try:
                ...
                error_msg = f"Failed to read {item_table} table: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
            ...
            try:
                ...
                error_msg = f"Failed to read {item_attr_value_mapping_table} table: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
            ...
            try:
                ...
                error_msg = f"Failed to join tables: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
            ...
            try:
                ...
                error_msg = f"Failed to write bridge table: {str(err)}"
                logging.error(error_msg)
                raise DimensionResolutionError(error_msg) from err
        ...
        error_msg = f"Unexpected error in create_item_attribute_bridge: {str(err)}"
        logging.error(error_msg)
        raise DimensionResolutionError(error_msg) from err
