...
from bc_etl.utils.exceptions import DimensionJoinError
    ...
    try:
        with logging.span("join_dimension", dimension_name=dimension_name):
            ...
            try:
                ...
                logging.error(
                    f"Failed to load dimension table {dim_table_path}: {str(e)}. Skipping join."
                )
        ...
        error_msg = f"Failed to join dimension {dimension_name}: {str(e)}"
