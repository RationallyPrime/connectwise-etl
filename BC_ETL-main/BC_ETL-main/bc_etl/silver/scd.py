# bc_etl/silver/scd.py
import pyspark.sql.functions as F  # noqa: F401, N812
from pyspark.sql import DataFrame
from pyspark.sql.window import Window

from bc_etl.utils import logging
from bc_etl.utils.exceptions import SCDHandlingError
...
def apply_scd_type_1(
    ...
    try:
        ...
        error_msg = f"Failed to apply SCD Type 1 handling: {str(e)}"
...
def apply_scd_type_2(
    ...
    try:
        ...
        error_msg = f"Failed to apply SCD Type 2 handling: {str(e)}"
        logging.error(error_msg, business_keys=business_keys)
        raise SCDHandlingError(error_msg) from e
