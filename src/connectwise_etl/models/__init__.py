...
class ActivityStopwatch(SparkModel):
    ...
    status: Literal['Reset', 'Running', 'Paused', 'Stopped'] | None = None
...
class Addition(SparkModel):
    ...
    billCustomer: Literal['Billable', 'DoNotBill', 'NoCharge'] | None = None
...
class Agreement(SparkModel):
    ...
    employeeCompRate: Annotated[
        Literal['Actual', 'Hourly'] | None, Field(description=' Required On Updates;')
    ] = None
    ...
    invoicingCycle: Annotated[
        Literal['ContractYear', 'CalendarYear'] | None,
    ...
    billTime: Annotated[
        Literal['Billable', 'DoNotBill', 'NoCharge', 'NoDefault'] | None,
        Field(description=' Required On Updates;'),
    ] = None
...
class AgreementTypeWorkRole(SparkModel):
    ...
    rateType: Literal['AdjAmount', 'Custom', 'Multiplier'] | None = None
...
AgreementTypeWorkRoleInfo = AgreementTypeWorkRoleExclusion
...
class BillingSetupRouting(SparkModel):
    ...
    invoiceRule: Literal['All', 'Standard', 'Project', 'Agreement'] | None = None
    routingRule: (
        Literal[
            'Account',
            'Territory',
...
class CatalogItem(SparkModel):
    ...
    productClass: Annotated[
        ...
        Field(description='Defaults to Non-Inventory.'),
    ] = None
...
class ConnectWiseHostedSetup(SparkModel):
    ...
    type: Literal['Tab', 'Pod', 'ToolbarButton'] | None = None
    clientId: Annotated[
        str | None,
...
class CustomReport(SparkModel):
    ...
    module: Annotated[
        ...
        | None,
        Field(description='The Module Name.'),
    ] = None
...
class DocumentInfo(SparkModel):
    ...
    guid: Annotated[
        UUID | None, Field(examples=['00000000-0000-0000-0000-000000000000'])
    ] = None
    field_info: Annotated[dict[str, str] | None, Field(alias='_info')] = None
...
class ExpenseType(SparkModel):
    ...
    invoiceMarkupOption: Literal['Amount', 'Mile', 'Percent'] | None = None
...
class ManagedDevicesIntegration(SparkModel):
    ...
    loginBy: Literal['Global', 'Member'] | None = None
    ...
    defaultBillingLevel: Literal['Detail', 'Summary'] | None = None
...
class ManagementBackup(SparkModel):
    ...
    billingLevel: Literal['Detail', 'Summary'] | None = None
    field_info: Annotated[dict[str, str] | None, Field(alias='_info')] = None
...
class MemberDelegation(SparkModel):
    id: int | None = None
    delegationType: Literal['Approval', 'Project'] | None = None
...
class MemberNotificationSetting(SparkModel):
    id: int | None = None
    notificationType: Literal['Email', 'Push'] | None = None
    notificationTrigger: (
        Literal[
            'ActivityStatusReq',
            'CustomerUpdated',
...
class MemberSkill(SparkModel):
    id: int | None = None
    skill: SkillReference | None = None
    skillLevel: Literal['Beginner', 'Intermediate', 'Advanced', 'Expert'] | None = None
...
class ProcurementSetting(SparkModel):
    ...
    costingMethod: Literal['FIFO', 'LIFO', 'AverageCosting'] | None = None
...
class ProductItem(SparkModel):
    ...
    billableOption: Literal['Billable', 'DoNotBill', 'NoCharge'] | None = None
    agreement: AgreementReference | None = None
    locationId: Annotated[int | None, Field(description=' Required On Updates;')] = None
    location: SystemLocationReference | None = None
    businessUnitId: Annotated[
...
class Project(SparkModel):
    ...
    billingRateType: Annotated[
        Literal['StaffMember', 'WorkRole'] | None,
        Field(description=' Required On Updates;'),
    ] = None
    billingTerms: BillingTermsReference | None = None
    billProducts: Annotated[
    ...
    budgetAnalysis: Annotated[
        Literal['ActualHours', 'BillableHours'] | None,
        Field(description=' Required On Updates;'),
    ] = None
...
class SLA(SparkModel):
    ...
    basedOn: Literal['AllHours', 'Customer', 'MyCalendar', 'Custom'] | None = None
...
SalesProbabilityInfo = SalesProbability
...
class Service(SparkModel):
    ...
    scheduleSpan: Literal['Standard', 'OfficeHours', 'Overnight'] | None = None
...
class ServiceLocation(SparkModel):
    id: int | None = None
    name: Annotated[str | None, Field(description=' Max length: 30;')] = None
    where: Literal['OnSite', 'Remote', 'InHouse'] | None = None
    defaultFlag: bool | None = None
    field_info: Annotated[dict[str, str] | None, Field(alias='_info')] = None
...
class ServiceSurveyQuestion(SparkModel):
    id: int | None = None
    sequenceNumber: int | None = None
    type: Literal['OpenEnded', 'Selection'] | None = None
    question: Annotated[str | None, Field(description=' Max length: 1000;')] = None
...
class SsoConfiguration(SparkModel):
    ...
    ssoType: Annotated[
        Literal['CWSSO', 'SAML'] | None, Field(description='Type of SSO Configuration')
    ] = None
...
class TaxCodeLevel(SparkModel):
    ...
    taxLevel: int | None = None
    taxRate: float | None = None
    rateType: Literal['Amount', 'Percent'] | None = None
...
class Team(SparkModel):
    id: int | None = None
    type: Literal['Individual', 'Team'] | None = None
    member: MemberReference | None = None
...
class TicketSync(SparkModel):
    ...
    vendorType: Literal['Zenith'] | None = None
    integratorLogin: IntegratorLoginReference | None = None
    company: CompanyReference | None = None
    url: str | None = None
    userName: str | None = None
...
class TimeAccrualDetail(SparkModel):
    ...
    accrualType: Annotated[
        Literal['Holiday', 'PTO', 'Sick', 'Vacation'] | None,
...
class TimeEntryChangeLog(SparkModel):
    ...
    billableOption: Annotated[
        Literal['Billable', 'DoNotBill', 'NoCharge', 'NoDefault'] | None,
        Field(description='Billable Option.'),
    ] = None
    ...
    chargeToType: Annotated[
        Literal['Company', 'ServiceTicket', 'ProjectTicket', 'ChargeCode', 'Activity']
        | None,
        Field(description='Charge To Type.'),
    ] = None
...
class TimePeriodSetup(SparkModel):
    id: int | None = None
    periodApplyTo: Literal['Both', 'Expense', 'Time'] | None = None
    year: int | None = None
    numberFuturePeriods: int | None = None
    type: Literal['Weekly', 'BiWeekly', 'SemiMonthly', 'Monthly'] | None = None
    description: Annotated[str | None, Field(description=' Max length: 100;')] = None
...
class WorkType(SparkModel):
    id: int | None = None
    name: Annotated[str | None, Field(description=' Max length: 50;')] = None
    billTime: Literal['Billable', 'DoNotBill', 'NoCharge'] | None = None
    rateType: Literal['AdjAmount', 'Custom', 'Multiplier'] | None = None
    rate: float | None = None
    hoursMin: float | None = None
    hoursMax: float | None = None
...
class Workflow(SparkModel):
    ...
    batchFrequencyUnit: Annotated[
        Literal['Minutes', 'Hours', 'Days'] | None,
        Field(
    ...
    batchSchedule: Annotated[
        Literal['AnyTime', 'MyCompanyOfficeHours', 'SlaHours'] | None,
...
class WorkflowEvent(SparkModel):
    ...
    frequencyUnit: Annotated[
        Literal['Minutes', 'Hours', 'Days', 'Months'] | None,
        Field(
    ...
    executionTime: Annotated[
        Literal['Once', 'MultipleTimes', 'Continuously'] | None,
