...
from .config.entity import DataType
from .config.fact import CalculatedColumn
...
def create_agreement_entity_config() -> EntityConfig:
    ...
    # Column mappings for nested API fields - removed problematic _info.lastUpdated mappings
    column_mappings = {
        # Removed info_lastUpdated mapping due to column structure mismatch
